    ...
    attrs.forEach((attribute) => {
      ...
      switch (attribute.type) {
        ...
        case 'url':
          ...
          break;
        case 'datetime':
          valid.datetime = validate.datetime(inputValue) && inputValue.length === 16 || inputValue === '' ? inputValue : false;
        ...
        case 'date':
          ...
          break;
        case 'time':
          valid.time = validate.time(inputValue) && inputValue.length === 5 || inputValue === '' ? inputValue : false;
